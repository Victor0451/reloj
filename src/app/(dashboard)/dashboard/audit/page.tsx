    ...
    <div className="space-y-8">
      <div className="animate-in-premium page-header">
        ...
        <p className="text-muted-foreground">
          Log inmutable de acciones de operadores
        </p>
      </div>
        ...
        <Card className="glass-card">
          <CardHeader>
            <div className="flex items-center gap-2">
              ...
              <span className="text-lg font-semibold">Log de Acciones</span>
            </div>
          ...
          <CardContent>
            <div className="flex flex-col items-center justify-center rounded-xl border border-dashed border-border/50 bg-muted/20 py-16 text-center">
              ...
              <h3 className="mb-1 text-base font-medium text-foreground">Sin registros aún</h3>
              <p className="mx-auto mb-4 max-w-sm text-sm text-muted-foreground">
                Las acciones de los operadores quedarán registradas automáticamente. Este log es inmutable.
              </p>
            </div>
          </CardContent>
        </Card>
